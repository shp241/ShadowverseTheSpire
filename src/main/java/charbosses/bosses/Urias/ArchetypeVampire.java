...
import charbosses.bosses.KMR.ArchetypeBaseKMR;
import charbosses.cards.AbstractBossCard;
import charbosses.cards.bishop.*;
import charbosses.cards.nemesis.EnMoonAlmiraj;
import charbosses.cards.vampire.*;
import charbosses.powers.bossmechanicpowers.EnemyNightmareTimePower;
...
public class ArchetypeVampire extends ArchetypeBaseVampire {
    ...
    public ArchetypeVampire() {
        ...
        if (AbstractDungeon.ascensionLevel >= 19) {
            this.maxHPModifier += 150;
        } else if (AbstractDungeon.ascensionLevel >= 4) {
            this.maxHPModifier += 100;
        }
        this.actNum = 2;
        this.looped = true;
    }
