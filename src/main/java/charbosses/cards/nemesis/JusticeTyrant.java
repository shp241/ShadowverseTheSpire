...
//        addToBot(new AnimationAction(KMR.bigAnimation, "extra", 3.0F, false));
        ...
        AbstractMonster m1 = new WorldEliminator(-70.0F + -135.0F * 1, MathUtils.random(-5.0F, 25.0F));
        AbstractMonster m2 = new WorldEliminator(-70.0F + -135.0F * 2, MathUtils.random(-5.0F, 25.0F));
        AbstractMonster m3 = new WorldEliminator(-70.0F + -135.0F * 1, MathUtils.random(25.0F, 55.0F));
        AbstractMonster m4 = new WorldEliminator(-70.0F + -135.0F * 2, MathUtils.random(25.0F, 55.0F));
