...
public class GetEPAction extends AbstractGameAction {
    ...
    public GetEPAction(boolean armamentsPlus,int EPAmount) {
    ...
    public void update() {
        ...
        if (this.duration == Settings.ACTION_DUR_FAST) {
            if (this.upgraded) {
                ...
                addToTop((AbstractGameAction)new MakeTempCardInHandAction((AbstractCard)new Miracle(), EPAmount));
                this.isDone = true;
                return;
            }
