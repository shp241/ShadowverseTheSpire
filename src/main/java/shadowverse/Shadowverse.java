...
/*  59 */     BaseMod.addColor(Witchcraft.Enums.COLOR_BLUE, WITCH_BLUE, WITCH_BLUE, WITCH_BLUE, WITCH_BLUE, WITCH_BLUE, WITCH_BLUE, WITCH_BLUE, "img/512card/bg_attack_default_gray.png", "img/512card/bg_skill_default_gray.png", "img/512card/bg_power_default_gray.png", "img/512card/card_default_gray_orb.png", "img/1024card/bg_attack_default_gray.png", "img/1024card/bg_skill_default_gray.png", "img/1024card/bg_power_default_gray.png", "img/1024card/card_default_gray_orb.png", "img/512card/card_small_orb.png");
...
/*  77 */     Keywords keywords = (Keywords)gson.fromJson(loadJson(keywordsPath), Keywords.class);
/*  78 */     Keyword[] var4 = keywords.keywords;
/*  79 */     int var5 = var4.length;
...
/*  94 */     HashMap<String, Sfx> reflectedMap = getSoundsMap();
/*  95 */     reflectedMap.put("spell_boost", new Sfx("sounds/spell_boost2.wav"));
/*  96 */     reflectedMap.put("EarthEssence", new Sfx("sounds/EarthEssence.wav"));
/*  97 */     reflectedMap.put("witch_selected", new Sfx("sounds/witch_selected.wav"));
/*  98 */     reflectedMap.put("OmenOfTruth", new Sfx("sounds/OmenOfTruth.wav"));
/*  99 */     reflectedMap.put("DimensionalWitch", new Sfx("sounds/DimensionalWitch.wav"));
/* 100 */     reflectedMap.put("DimensionShift", new Sfx("sounds/DimensionShift.wav"));
/* 101 */     reflectedMap.put("ZealotOfTruth", new Sfx("sounds/ZealotOfTruth.wav"));
/* 102 */     reflectedMap.put("MysticSeeker", new Sfx("sounds/MysticSeeker.wav"));
/* 103 */     reflectedMap.put("EdictOfTruth", new Sfx("sounds/EdictOfTruth.wav"));
/* 104 */     reflectedMap.put("Lou", new Sfx("sounds/Lou.wav"));
/* 105 */     reflectedMap.put("TruthsAdjudication", new Sfx("sounds/TruthsAdjudication.wav"));
/* 106 */     reflectedMap.put("MasterMageLevi", new Sfx("sounds/MasterMageLevi.wav"));
/* 107 */     reflectedMap.put("PiousInstructor", new Sfx("sounds/PiousInstructor.wav"));
/* 108 */     reflectedMap.put("PiousInstructorPower", new Sfx("sounds/PiousInstructorPower.wav"));
/* 109 */     reflectedMap.put("Clarke", new Sfx("sounds/Clarke.wav"));
/* 110 */     reflectedMap.put("Clarke_Accelerate", new Sfx("sounds/Clarke_Accelerate.wav"));
/* 111 */     reflectedMap.put("Faust", new Sfx("sounds/Faust.wav"));
/* 112 */     reflectedMap.put("FaustPower", new Sfx("sounds/FaustPower.wav"));
/* 113 */     reflectedMap.put("Magisa", new Sfx("sounds/Magisa.wav"));
/* 114 */     reflectedMap.put("Chaos", new Sfx("sounds/Chaos.wav"));
/* 115 */     reflectedMap.put("Runie", new Sfx("sounds/Runie.wav"));
/* 116 */     reflectedMap.put("ForbiddenDarkMage", new Sfx("sounds/ForbiddenDarkMage.wav"));
/* 117 */     reflectedMap.put("DarkMagePower", new Sfx("sounds/DarkMagePower.wav"));
/* 118 */     reflectedMap.put("JetBroomWitch", new Sfx("sounds/JetBroomWitch.wav"));
/* 119 */     reflectedMap.put("TetrasMettle", new Sfx("sounds/TetrasMettle.wav"));
/* 120 */     reflectedMap.put("IsabellesConjuration", new Sfx("sounds/IsabellesConjuration.wav"));
/* 121 */     reflectedMap.put("SorceryInSolidarity", new Sfx("sounds/SorceryInSolidarity.wav"));
/* 122 */     reflectedMap.put("MechabookSorcerer", new Sfx("sounds/MechabookSorcerer.wav"));
/* 123 */     reflectedMap.put("SonicFour", new Sfx("sounds/SonicFour.wav"));
/* 124 */     reflectedMap.put("Tetra", new Sfx("sounds/Tetra.wav"));
/* 125 */     reflectedMap.put("MechastaffSorcerer", new Sfx("sounds/MechastaffSorcerer.wav"));
/* 126 */     reflectedMap.put("ArsMagna", new Sfx("sounds/ArsMagna.wav"));
/* 127 */     reflectedMap.put("Cagliostro1", new Sfx("sounds/Cagliostro1.wav"));
/* 128 */     reflectedMap.put("Cagliostro2", new Sfx("sounds/Cagliostro2.wav"));
/* 129 */     reflectedMap.put("Awakened", new Sfx("sounds/Awakened.wav"));
/* 130 */     reflectedMap.put("ErasmusPower", new Sfx("sounds/ErasmusPower.wav"));
/* 131 */     reflectedMap.put("Erasmus", new Sfx("sounds/Erasmus.wav"));
/* 132 */     reflectedMap.put("Oz", new Sfx("sounds/Oz.wav"));
/* 133 */     reflectedMap.put("OzPower", new Sfx("sounds/OzPower.wav"));
/* 134 */     reflectedMap.put("Geoelementist", new Sfx("sounds/Geoelementist.wav"));
/* 135 */     reflectedMap.put("Stormelementalist", new Sfx("sounds/Stormelementalist.wav"));
/* 136 */     reflectedMap.put("Pyromancer", new Sfx("sounds/Pyromancer.wav"));
/* 137 */     reflectedMap.put("Riley", new Sfx("sounds/Riley.wav"));
/* 138 */     reflectedMap.put("DualAngle", new Sfx("sounds/DualAngle.wav"));
/* 139 */     reflectedMap.put("Ghios", new Sfx("sounds/Ghios.wav"));
/* 140 */     reflectedMap.put("OmenOfOne", new Sfx("sounds/OmenOfOne.wav"));
/* 141 */     reflectedMap.put("Mysteria", new Sfx("sounds/Mysteria.wav"));
/* 142 */     reflectedMap.put("EarthFall", new Sfx("sounds/EarthFall.wav"));
/* 143 */     reflectedMap.put("InfernalSurge", new Sfx("sounds/InfernalSurge.wav"));
/* 144 */     reflectedMap.put("InfernalGaze", new Sfx("sounds/InfernalGaze.wav"));
/* 145 */     reflectedMap.put("HeavenFall", new Sfx("sounds/HeavenFall.wav"));
/* 146 */     reflectedMap.put("Flamelord", new Sfx("sounds/Flamelord.wav"));
/* 147 */     reflectedMap.put("ViciousCommander", new Sfx("sounds/ViciousCommander.wav"));
/* 148 */     reflectedMap.put("WrathfulIcefiend", new Sfx("sounds/WrathfulIcefiend.wav"));
/* 149 */     reflectedMap.put("HellBeast", new Sfx("sounds/HellBeast.wav"));
/* 150 */     reflectedMap.put("Satan", new Sfx("sounds/Satan.wav"));
/* 151 */     reflectedMap.put("Satan_Accelerate", new Sfx("sounds/Satan_Accelerate.wav"));
/* 152 */     reflectedMap.put("EmbodimentOfCocytus", new Sfx("sounds/EmbodimentOfCocytus.wav"));
/* 153 */     reflectedMap.put("Eleanor", new Sfx("sounds/Eleanor.wav"));
...
/* 160 */     BaseMod.addRelicToCustomPool((AbstractRelic)new EnchantedLibrary(), Witchcraft.Enums.COLOR_BLUE);
/* 161 */     BaseMod.addRelicToCustomPool((AbstractRelic)new EarthEssenceRelic(), Witchcraft.Enums.COLOR_BLUE);
/* 162 */     BaseMod.addRelicToCustomPool((AbstractRelic)new shadowverse.relics.Mysteria(), Witchcraft.Enums.COLOR_BLUE);
/* 164 */     BaseMod.addRelicToCustomPool((AbstractRelic)new Offensive(), Witchcraft.Enums.COLOR_BLUE);
...
/* 178 */     String relicsPath = "localization/relics-" + Settings.language + ".json";
...
/* 182 */     BaseMod.loadCustomStringsFile(RelicStrings.class, relicsPath);
...
/* 190 */     BaseMod.addCard((AbstractCard)new Defend_W());
/* 191 */     BaseMod.addCard((AbstractCard)new Insight());
/* 192 */     BaseMod.addCard((AbstractCard)new FieryEmbrace());
/* 193 */     BaseMod.addCard((AbstractCard)new FatesHand());
/* 194 */     BaseMod.addCard((AbstractCard)new Lou());
/* 195 */     BaseMod.addCard((AbstractCard)new Ogler());
/* 196 */     BaseMod.addCard((AbstractCard)new ZealotOfTruth());
/* 197 */     BaseMod.addCard((AbstractCard)new MagicMissile());
/* 198 */     BaseMod.addCard((AbstractCard)new DimensionShift());
/* 199 */     BaseMod.addCard((AbstractCard)new MagicOwl());
/* 200 */     BaseMod.addCard((AbstractCard)new FireChain());
/* 201 */     BaseMod.addCard((AbstractCard)new GigantChimera());
/* 202 */     BaseMod.addCard((AbstractCard)new OmenOfTruth());
/* 203 */     BaseMod.addCard((AbstractCard)new DimensionalWitch());
/* 204 */     BaseMod.addCard((AbstractCard)new MysticSeeker());
/* 205 */     BaseMod.addCard((AbstractCard)new EdictOfTruth());
/* 206 */     BaseMod.addCard((AbstractCard)new TruthsAdjudication());
/* 207 */     BaseMod.addCard((AbstractCard)new MysterianKnowledge());
/* 208 */     BaseMod.addCard((AbstractCard)new MysterianCircle());
/* 209 */     BaseMod.addCard((AbstractCard)new MysterianMissile());
/* 210 */     BaseMod.addCard((AbstractCard)new CommenceExperiment());
/* 211 */     BaseMod.addCard((AbstractCard)new MasterMageLevi());
/* 212 */     BaseMod.addCard((AbstractCard)new Concentration());
/* 213 */     BaseMod.addCard((AbstractCard)new PiousInstructor());
/* 214 */     BaseMod.addCard((AbstractCard)new ConjureGuardian());
/* 215 */     BaseMod.addCard((AbstractCard)new GolemAssault());
/* 216 */     BaseMod.addCard((AbstractCard)new Clarke());
/* 217 */     BaseMod.addCard((AbstractCard)new Faust());
/* 218 */     BaseMod.addCard((AbstractCard)new OrichalcumGolem());
/* 219 */     BaseMod.addCard((AbstractCard)new DwarfAlchemist());
/* 220 */     BaseMod.addCard((AbstractCard)new WitchsCauldron());
/* 221 */     BaseMod.addCard((AbstractCard)new Magisa());
/* 222 */     BaseMod.addCard((AbstractCard)new StaffOfWhirlwinds());
/* 223 */     BaseMod.addCard((AbstractCard)new ConjureTwosome());
/* 224 */     BaseMod.addCard((AbstractCard)new Petrification());
/* 225 */     BaseMod.addCard((AbstractCard)new AbsoluteZeroBlade());
/* 226 */     BaseMod.addCard((AbstractCard)new Chaos());
/* 227 */     BaseMod.addCard((AbstractCard)new ChainLightning());
/* 228 */     BaseMod.addCard((AbstractCard)new Runie());
/* 229 */     BaseMod.addCard((AbstractCard)new Telescope());
/* 230 */     BaseMod.addCard((AbstractCard)new ForbiddenDarkMage());
/* 231 */     BaseMod.addCard((AbstractCard)new ProductMachine());
/* 232 */     BaseMod.addCard((AbstractCard)new RepairMode());
/* 233 */     BaseMod.addCard((AbstractCard)new JetBroomWitch());
/* 234 */     BaseMod.addCard((AbstractCard)new TetrasMettle());
/* 235 */     BaseMod.addCard((AbstractCard)new IsabellesConjuration());
/* 236 */     BaseMod.addCard((AbstractCard)new SorceryInSolidarity());
/* 237 */     BaseMod.addCard((AbstractCard)new MechanizedLifeform());
/* 238 */     BaseMod.addCard((AbstractCard)new MagitechGolem());
/* 239 */     BaseMod.addCard((AbstractCard)new MechabookSorcerer());
/* 240 */     BaseMod.addCard((AbstractCard)new SonicFour());
/* 241 */     BaseMod.addCard((AbstractCard)new Tetra());
/* 242 */     BaseMod.addCard((AbstractCard)new MechastaffSorcerer());
/* 243 */     BaseMod.addCard((AbstractCard)new ArsMagna());
/* 244 */     BaseMod.addCard((AbstractCard)new Cagliostro());
/* 245 */     BaseMod.addCard((AbstractCard)new MadcapConjuration());
/* 246 */     BaseMod.addCard((AbstractCard)new Awakened());
/* 247 */     BaseMod.addCard((AbstractCard)new Erasmus());
/* 248 */     BaseMod.addCard((AbstractCard)new Oz());
/* 249 */     BaseMod.addCard((AbstractCard)new GrandSummoning());
/* 250 */     BaseMod.addCard((AbstractCard)new Shop());
/* 251 */     BaseMod.addCard((AbstractCard)new NaterranGreatTree());
/* 252 */     BaseMod.addCard((AbstractCard)new Geoelementist());
/* 253 */     BaseMod.addCard((AbstractCard)new Stormelementalist());
/* 254 */     BaseMod.addCard((AbstractCard)new Pyromancer());
/* 255 */     BaseMod.addCard((AbstractCard)new Elementalmana());
/* 256 */     BaseMod.addCard((AbstractCard)new Riley());
/* 257 */     BaseMod.addCard((AbstractCard)new ApexElemental());
/* 258 */     BaseMod.addCard((AbstractCard)new DualAngle());
/* 259 */     BaseMod.addCard((AbstractCard)new Ghios());
/* 260 */     BaseMod.addCard((AbstractCard)new OmenOfOne());
/* 261 */     BaseMod.addCard((AbstractCard)new Mysteria());
/* 262 */     BaseMod.addCard((AbstractCard)new EarthFall());
/* 263 */     BaseMod.addCard((AbstractCard)new InfernalSurge());
/* 264 */     BaseMod.addCard((AbstractCard)new InfernalGaze());
/* 265 */     BaseMod.addCard((AbstractCard)new HeavenFall());
/* 266 */     BaseMod.addCard((AbstractCard)new Astaroth());
/* 267 */     BaseMod.addCard((AbstractCard)new Scorpion());
/* 268 */     BaseMod.addCard((AbstractCard)new Flamelord());
/* 269 */     BaseMod.addCard((AbstractCard)new ViciousCommander());
/* 270 */     BaseMod.addCard((AbstractCard)new WrathfulIcefiend());
/* 271 */     BaseMod.addCard((AbstractCard)new Behemoth());
/* 272 */     BaseMod.addCard((AbstractCard)new DemonOfPurgatory());
/* 273 */     BaseMod.addCard((AbstractCard)new Desire());
/* 274 */     BaseMod.addCard((AbstractCard)new Satan());
/* 275 */     BaseMod.addCard((AbstractCard)new EmbodimentOfCocytus());
