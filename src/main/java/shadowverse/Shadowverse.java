...
/*     */ public class Shadowverse implements PostInitializeSubscriber, EditCardsSubscriber, EditStringsSubscriber, EditKeywordsSubscriber, EditCharactersSubscriber, EditRelicsSubscriber {
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool((AbstractRelic) new TranquilCog(),Nemesis.Enums.COLOR_SKY);
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard((AbstractCard)new NightVampire());
        ...
        BaseMod.addCard((AbstractCard)new GenesisArtifact());
        BaseMod.addCard((AbstractCard)new GuardArtifact());
        BaseMod.addCard((AbstractCard)new DefectArtifact());
        BaseMod.addCard((AbstractCard)new CannonArtifact());
        BaseMod.addCard((AbstractCard)new Zwei());
        BaseMod.addCard((AbstractCard)new Illganeau());
        BaseMod.addCard((AbstractCard)new VoidRealize());
        BaseMod.addCard((AbstractCard)new Wretches());
        BaseMod.addCard((AbstractCard)new BrandOfMorningStar());
        BaseMod.addCard((AbstractCard)new ShadowSoldier());
        BaseMod.addCard((AbstractCard)new ShadowCommander());
        BaseMod.addCard((AbstractCard)new TheWheelOfFortune());
        BaseMod.addCard((AbstractCard)new Scavenge());
        BaseMod.addCard((AbstractCard)new EnhancedPuppet());
        BaseMod.addCard((AbstractCard)new RevisedExperiment());
        BaseMod.addCard((AbstractCard)new Sleipnir());
        BaseMod.addCard((AbstractCard)new Odin());
        BaseMod.addCard((AbstractCard)new KMRGaze());
        BaseMod.addCard((AbstractCard)new WUP());
        BaseMod.addCard((AbstractCard)new Altersphere());
        BaseMod.addCard((AbstractCard)new Death());
        BaseMod.addCard((AbstractCard)new Betray());
        BaseMod.addCard((AbstractCard)new Rowen());
        BaseMod.addCard((AbstractCard)new CurseOfTheBlackDragon());
        BaseMod.addCard((AbstractCard)new ShadowversePain());
        BaseMod.addCard((AbstractCard)new ShadowBahmut());
