...
public class Fafnir extends CustomCard {
    ...
    public static final String DESCRIPTION = cardStrings.DESCRIPTION; public static final String IMG_PATH = "img/cards/Fafnir.png";
    public Fafnir() {
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        addToBot((AbstractGameAction)new SFXAction("Fafnir"));
        ...
        addToBot((AbstractGameAction)new NecromanceAction(playerNecromance,null,
                (AbstractGameAction)new DamageAllEnemiesAction((AbstractCreature)abstractPlayer, DamageInfo.createDamageMatrix(this.magicNumber*playerNecromance, true), DamageInfo.DamageType.THORNS, AbstractGameAction.AttackEffect.NONE, true)));
