...
public class FrontguardGeneral extends Minion {
    ...
    public void updateDescription() { // Set the on-hover description of the orb
        description = DESCRIPTIONS[0] + this.attack + DESCRIPTIONS[1] + this.attack + DESCRIPTIONS[2];
    }
    ...
    public void effect() {
        ...
        AbstractDungeon.actionManager.addToBottom(new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, this.attack));
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new PlatedArmorPower(p, this.attack), 2));
    }
